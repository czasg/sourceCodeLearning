...
# 直接指定执行周期，不会停止
sch.add_job(my_job1, 'interval', seconds=10)  # jitter是振动参数，每周期会随机增加浮动秒数

# start_date 指定开始时间与结束时间
sch.add_job(my_job2, 'interval', seconds=5, start_date='2019-12-30 09:50:00', end_date='2019-12-30 22:00:00')
sch.start()
